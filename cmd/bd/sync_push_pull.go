...
// pullDependencySources is the shared --relations gate for Jira and Linear pulls.
...
// opt-in for these two trackers. GitLab relation import does not use this gate.
// Parent edges import regardless of --relations and retain normal parent-child
// semantics, including readiness inheritance and preventing parent closure while
