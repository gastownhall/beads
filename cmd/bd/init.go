...
environment variable.`,
	Run: func(cmd *cobra.Command, _ []string) {
		...
		if backendFlag == "sqlite" {
			...
			fmt.Fprintf(os.Stderr, "See: https://github.com/gastownhall/beads/blob/main/docs/DOLT-BACKEND.md\n")
			os.Exit(1)
		...
		if isWorktree && !hasExplicitBeadsDir {
			...
			fmt.Fprintf(os.Stderr, "For more information, see: https://github.com/gastownhall/beads/blob/main/docs/WORKTREES.md\n")
			os.Exit(1)
		}
