...
**Learn more:** [github.com/jonbaldie/beads](https://github.com/jonbaldie/beads)
...
` + "```bash" + `
# Install Beads
curl -sSL https://raw.githubusercontent.com/jonbaldie/beads/main/scripts/install.sh | bash
...
- **Documentation**: [github.com/jonbaldie/beads/docs](https://github.com/jonbaldie/beads/tree/main/docs)
- **Quick Start Guide**: Run ` + "`bd quickstart`" + `
- **Examples**: [github.com/jonbaldie/beads/examples](https://github.com/jonbaldie/beads/tree/main/examples)
