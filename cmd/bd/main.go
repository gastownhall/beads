...
func init() {
	...
	// Compatibility: gt (gastown) passes --allow-stale to all bd commands.
	// Accept and ignore it so bd doesn't error on unknown flag.
	rootCmd.PersistentFlags().Bool("allow-stale", false, "Ignored (kept for gt compatibility)")
