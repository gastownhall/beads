...
func (s *configStore) SlotSet(_ context.Context, _, _, _ string) error       { return nil }
func (s *configStore) SlotGet(_ context.Context, _, _ string) (string, bool, error) {
	return "", false, nil
}
func (s *configStore) SlotClear(_ context.Context, _, _ string) error { return nil }
