...
func CloneUpdateRequest(request publicops.UpdateRequest) publicops.UpdateRequest {
	...
	clone.Patch.RepeatStart.Value = cloneTime(request.Patch.RepeatStart.Value)
	clone.Patch.RepeatEnd.Value = cloneTime(request.Patch.RepeatEnd.Value)
...
func clonePublicIssue(issue *publicops.Issue) *publicops.Issue {
	...
	clone.RepeatStart = cloneTime(issue.RepeatStart)
	clone.RepeatEnd = cloneTime(issue.RepeatEnd)
