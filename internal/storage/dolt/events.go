...
func (s *DoltStore) AddIssueComment(ctx context.Context, issueID, author, text string) (*types.Comment, error) {
	return s.addOrImportComment(ctx, issueID, []string{"comments", "issues"}, func(tx *sql.Tx) (*types.Comment, error) {
...
func (s *DoltStore) ImportIssueComment(ctx context.Context, issueID, author, text string, createdAt time.Time) (*types.Comment, error) {
	return s.addOrImportComment(ctx, issueID, []string{"comments"}, func(tx *sql.Tx) (*types.Comment, error) {
...
func (s *DoltStore) addOrImportComment(ctx context.Context, issueID string, tables []string, insert func(*sql.Tx) (*types.Comment, error)) (*types.Comment, error) {
	...
	err := s.withCircuitWrite(ctx, func(ctx context.Context) error {
		...
		return s.doltAddAndCommit(ctx, tables, fmt.Sprintf("bd: comment %s", issueID))
	})
	if err != nil {
		return nil, err
	}
