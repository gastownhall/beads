...
**Note:** The `search` command is optimized for quick text searches and uses less context than `list`. For advanced filtering options, use `bd list`.
...
- You're using an LLM and want to minimize context usage
