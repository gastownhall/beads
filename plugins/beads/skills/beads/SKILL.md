...
If this skill's guidance differs from `bd prime`, treat `bd prime` as authoritative. It ships with the installed CLI and is the canonical source of truth ([ADR-0001](adr/0001-bd-prime-as-source-of-truth.md)).
