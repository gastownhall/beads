...
func RunAll(t *testing.T, factory Factory) {
	...
	t.Run("TransactionTouchIssue", func(t *testing.T) { testTransactionTouchIssue(t, factory) })
	t.Run("TransactionCloseIssueChecked", func(t *testing.T) { testTransactionCloseIssueChecked(t, factory) })
