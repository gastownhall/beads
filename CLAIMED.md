...
| Versioned beads Phase 3 — migration slots **0069–0071** (`0069_add_expected_revision_records`: R16 expected-revision CAS; `0070_add_epoch_minted_addresses`: R20 epochs; `0071_add_removed_restriction`: R7.1 as-of read; design #5898 / #6136) | @quad341 | 2026-09-10 | branches on quad341/beads-sec003-contrib; PR to follow after #6358. Proposed on #6149, with the bead graph starting at 0072 if @donnabox agrees |
